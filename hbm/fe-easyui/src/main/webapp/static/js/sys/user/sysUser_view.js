...
(function(){
		HgUi.toggleSearchBar("sysUser_toolbar",
			function() {
				sysUserGrid.grid.datagrid("resize");
		...
		sysUserGrid.toolbar.find("[tag=submit]").click(function(){
			...
			searchData["staffInfo.bo.entryStartTime"] =  $.trim(sysUserGrid.toolbar.find("[name=startTime]").val());
			searchData["staffInfo.bo.entryEndTime"] =  $.trim(sysUserGrid.toolbar.find("[name=endTime]").val());
