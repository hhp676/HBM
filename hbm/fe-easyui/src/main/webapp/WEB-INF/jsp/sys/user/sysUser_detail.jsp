					...
					<div class="easyui-layout" fit=true data-options="border:false">
						<div data-options="region:'north',border:false"
							...
							<form id="userAccountForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 76px;" align="right">登录名<font>*</font>：
										</td>
										<td style="width: 170px">
										  <input type="text" name="loginName" ${user.userId != null?'disabled':''}
                                            value="${user.userAccount.loginName}" style="width: 140px;" /><br />
										</td>
									...
									<tr>
										...
										<td colspan="3"><textarea name="descr" cols=80 rows=3 
												${mode == 'view'?'disabled':''}
												style="width: 365px; height: 30px;resize: none;">${user.userAccount.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
						...
						<div data-options="region:'center'" title="用户信息"
							...
							<form id="userInfoForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 76px;" align="right">用户名<font>*</font>：
										</td>
										<td style="width: 170px;"><input type="text"
											name="userName" value="${user.userName}"
											${mode == 'view'?'disabled':''} style="width: 140px;" /><br />
										</td>
										<td align="right" style="width: 70px;">英文名：</td>
									...
									<tr>
										...
										<td align="right"><nobr>手机号码：</nobr></td>
									...
									<tr>
										...
										<td style="width: 170px;"><input name="telephone"
											...
											value="${user.telephone}" style="width: 132px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">邮箱：</td>
										<td colspan="3"><input name="email"
											${mode == 'view'?'disabled':''} value="${user.email}"
											style="width: 375px;" /><br /> <label for="idCard"></label>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3"><input name="address"
											...
											style="width: 375px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">描述：</td>
										<td colspan="3"><textarea name="descr" cols=80 rows=3
												${mode == 'view'?'disabled':''}
												style="width: 366px; height: 30px;resize: none;">${user.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
						...
						<div data-options="region:'south'"
							...
							<form id="userStaffForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 78px;" align="right">员工号<font>*</font>：
										</td>
										...
										<td style="width: 170px;"><select type="text"
											...
											${mode == 'view'?'disabled':''} style="width: 134px;"
									...
									<tr>
										...
										<td><input name="idCard" ${mode == 'view'?'disabled':''}
											value="${user.staffInfo.idCard}" style="width: 140px;" /><br />
											<label for="idCard"></label></td>
										<td align="right">银行帐号：</td>
										<td><input name="bankCard"
											${mode == 'view'?'disabled':''}
											value="${user.staffInfo.bankCard}" style="width: 132px;" /><br />
									...
									<tr>
										...
										<td colspan="3"><textarea name="descr" cols=80 rows=3
												${mode == 'view'?'disabled':''}
												style="width: 367px; height: 30px;resize: none;">${user.staffInfo.descr}</textarea><br />
										</td>
									</tr>
								</table>
							</form>
						...
						<div title="权限信息">
							<table style="width: 100%" id="sysAuthManage_grid_userAuth_table">
								<tr>
									...
									<td width="130px"><input id="authName"></td>
									<td>
                                                  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search"
    										 onclick="sysAuthManage_grid_userAuth.searchStr();">定位</a>
                                                  <label id="treeGridShowNext">
                                                       <a href="javascript:void(0)"
                                                          class="easyui-linkbutton" iconCls="icon_auto_colorful__down"
                                                          onclick="sysAuthManage_grid_userAuth.showNext();">下一个</a>
                                                  </label>
                                             </td>
								</tr>
							</table>
						...
						<div title="负权限信息">
							<table style="width: 100%"
								...
								<tr>
									...
									<td>
                                                  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search"
										     onclick="sysAuthManage_grid_userNAuth.searchStr();">定位</a>
                                                  <label id="treeGridShowNext">
                                                       <a href="javascript:void(0)"
                                                          class="easyui-linkbutton" iconCls="icon_auto_colorful__down"
                                                          onclick="sysAuthManage_grid_userNAuth.showNext();">下一个</a>
                                                  </label>
                                             </td>
								</tr>
							</table>
