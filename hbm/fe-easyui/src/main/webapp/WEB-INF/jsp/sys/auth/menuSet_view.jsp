            ...
            <table fit=true id="menu_grid" class="easyui-treegrid"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'isTopMenu',width:20,formatter:function(value){return HgUtil.getDictItemName('trueOrFalse',value);},
                         editor:{type:'combobox',options:{data:logicMap,textField:'itemName',prompt: '---请选择---',
                            valueField:'itemValue',editable:false,panelHeight:'auto'}}">顶部菜单</th>
                        <th data-options="field:'isSubMenu',width:20,formatter:function(value){return HgUtil.getDictItemName('trueOrFalse',value);},
                         editor:{type:'combobox',options:{data:logicMap,textField:'itemName',prompt: '---请选择---',
