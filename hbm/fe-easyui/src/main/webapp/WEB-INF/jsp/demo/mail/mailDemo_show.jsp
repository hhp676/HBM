...
<body>
        ...
        <div data-options="region:'center',title:'邮件相关demo',border:false" style="padding: 0px; ">
            <div style="width: 900px;margin: 10px;border: 1px solid;">
             ...
             <form id="mailForm" class="hgform">
	             ...
	             <table width="900px" class="hgtable">
	                <tr>
             ...
             <div>
                <script id="mailBodyUeditor" type="text/plain" style="width:900px;"></script>
             </div>
        </div>
    </div>
    ...
    function sendTempleteMail(button){
   	...
   	function _sendMail(type,button){
   	   var receiver = $("#mailForm #receiver").val();
        if($.trim(receiver)==''){
            HgUi.error("收件人地址不能为空!");
            return false;
        }
    ...
    setTimeout(function(){
       ...
       UE.getEditor('mailBodyUeditor').addListener( 'ready', function( editor ) {
    	   UE.getEditor('mailBodyUeditor').setHeight(360);
       });
    }, 100);
    </script>
</body>
