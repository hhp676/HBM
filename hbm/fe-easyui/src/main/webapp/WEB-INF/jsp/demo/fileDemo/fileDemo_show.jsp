	                    ...
	                    <tr style="height: 60px;" valign="middle">
	                        ...
	                        <td style="position: relative;">
	                            <div style="float: left;">
	                                <input id="fileText" value="请选择上传文件" title="请选择上传文件" style="height: 20px;" disabled>
	                            </div>
	                            <div style="position: relative;width: 55px;height: 25px;float: left;margin-left: 2px;margin-top: -2px;">
	                                <a href="javascript:void(0)" class="easyui-linkbutton" 
	                                    id="addFiles" 
	                                    style="position: absolute;height: 25px;"
	                                    iconCls="icon-add1" tag="add">浏览</a>
	                                <input type="file" id="file" name="file"
	                                    ...
	                                    style="position: absolute;filter: alpha(opacity=0);opacity:0;
	                                        z-index: 2;width: 55px;height: 25px;">
	                            </div>
	                        </td>
	                    </tr>
	                </table>
