            ...
            <form id="sysAuth_form" class="hgform">
                ...
                <table class="hgtable">
                    ...
                    <tr height="30px;">
                        ...
                        <td width="250px;">
                            <select id="modelId" name="modelId" class="easyui-combotree" 
                                panelHeight='auto' panelMaxHeight="300" style="width:200px;height:25px;"   
                    ...
                    <tr height="30px;">
                        ...
                        <td align="right"><nobr>国际化编码：</nobr></td>
                    ...
                    <tr height="30px;">
                        ...
                        <td>
                             <select id="operationId" class="easyui-combogrid" style="width:200px;height:25px;" name="operationId"  
	                             data-options="
	                                panelWidth: 320,editable:false,fitColumns: true,
	                                idField: 'operationId',textField: 'operationName',
	                                url: '${ctx}/sys/sysOperation/list?rows=999',
	                                columns: [[
                    ...
                    <tr height="30px;">
                        ...
                        <td>
                            <c:forEach var="logicItem" items="${logicMap}">
                                <input type="radio" style="vertical-align:middle"name="isVisible" value="${logicItem.itemValue}" <c:if test="${authObj.isVisible == logicItem.itemValue}">checked='checked'</c:if>><font style="vertical-align:middle">${logicItem.itemName}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:forEach>
                        </td>
                        <td align="right"><nobr>是否可继承：</nobr></td>
                        <td>
                            <c:forEach var="logicItem" items="${logicMap}">
                                <input type="radio" style="vertical-align:middle" name="isInheritable" value="${logicItem.itemValue}" <c:if test="${authObj.isInheritable == logicItem.itemValue}">checked='checked'</c:if>><font style="vertical-align:middle">${logicItem.itemName}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:forEach>
                        </td>
                    </tr>
                    <tr height="30px;">
                        ...
                        <td colspan="3"><textarea type="text" name="uri" class="hgtextarea" style="height:70px;width:526px;" onfocus="showNote();" onblur="hideNote();">${authObj.uri}</textarea></td>
                    </tr>
                    <tr>
	                    <td></td>
	                    <td></td>
                    ...
                    <tr height="30px;">
                        ...
                        <td colspan="3"><textarea name="descr" class="" style="height:70px;width:526px;">${authObj.descr}</textarea></td>
                    </tr>
