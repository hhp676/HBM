		...
		<div data-options="region:'center'" style="padding: 10 10 10 20px;">
			<div class="easyui-layout" fit=true data-options="border:false">
				<div data-options="region:'center',border:false" >
						<div style="height: 115px; padding-top: 2px;">
							<div class='form-title'>登录信息</div>
							<form id="userAccountForm" class="hgform">
								<table class="hgtable">
									<tr>
										<td style="width: 80px;" align="right">登录名<sup>*</sup>：
										</td>
										<td style="width: 145px;">
										  <input type="text" name="loginName" <c:if test="${user.userId != null}">disabled</c:if>
                                            value="${user.userAccount.loginName}" style="width: 140px;" />
										</td>
										<td align="right" style="display: none; width: 80px;"
											tag="pwd">初始密码<sup>*</sup>：
										</td>
										<td style="width: 145px; display: none;" tag="pwd">
										  <input
									...
									<tr>
										...
										<td colspan="3"  ><textarea name="descr" 
												${mode == 'view'?'disabled':''}
												style="width: 367px; height: 26px;resize: none;">${user.userAccount.descr}</textarea>
										</td>
									</tr>
								</table>
							</form>
						...
						<div style="padding-top: 2px;">
							...
							<form id="userInfoForm" class="hgform">
								<table class="hgtable" >
									<tr>
										<td style="width: 80px;" align="right">用户名<sup>*</sup>：
										</td>
										<td style="width: 145px;">
												<input type="text"
										...
										<td align="right" style="width: 80px;">英文名：</td>
										<td style="width: 145px;"><input name="engName"
									...
									<tr>
										...
										<td style="width: 145px;"><select type="text"
										...
										<td style="width: 145px;"><input name="mobile"
											value="${user.mobile}" ${mode == 'view'?'disabled':''}
											style="width: 140px;" /><br /></td>
									</tr>
									<tr>
										<td align="right">生日：</td>
										<td style="width: 145px;"><input name="birthday"
										...
										<td style="width: 145px;"><input name="telephone"
									...
									<tr>
										...
										<td colspan="3"><input name="address"
											...
											style="width: 371px;" /></td>
									</tr>
									<tr>
										<td align="right">描述：</td>
										<td colspan="3"><textarea name="descr" 
												${mode == 'view'?'disabled':''}
												style="width: 371px; height: 26px;resize: none;">${user.descr}</textarea>
										</td>
									</tr>
								</table>
							</form>
						</div>
						<div style="height: 170px; padding-top: 2px;">
							<div class="form-title">员工信息</div>
							<form id="userStaffForm" class="hgform">
								<table class="hgtable" >
									<tr>
										<td style="width: 80px;" align="right">员工号<sup>*</sup>：
										</td>
										<td style="width: 145px;"><input name="staffCode"
											value="${user.staffInfo.staffCode}"
											${mode == 'view'?'disabled':''} style="width: 140px;" /><br />
										</td>
										<td style="width: 80px;" align="right">员工状态<sup>*</sup>：
										</td>
										<td style="width: 145px;"><select type="text"
									...
									<tr>
										...
										<td><input name="idCard" ${mode == 'view'?'disabled':''}
											value="${user.staffInfo.idCard}" style="width: 140px;" />
										<td align="right">银行帐号：</td>
										<td><input name="bankCard"
											${mode == 'view'?'disabled':''}
											value="${user.staffInfo.bankCard}" style="width: 140px;" />
									</tr>
									<tr>
										<td align="right">描述：</td>
										<td colspan="3"><textarea name="descr" 
												${mode == 'view'?'disabled':''}
												style="width: 371px; height: 26px;resize: none;">${user.staffInfo.descr}</textarea>
										</td>
									</tr>
								</table>
							</form>
