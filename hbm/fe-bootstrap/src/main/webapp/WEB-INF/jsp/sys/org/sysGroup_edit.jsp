...
<div id="sysGroupLayout" class="easyui-layout" fit="true">
    <div data-options="region:'center'" style="padding: 10px 10px 10px 20px;">
        <form id="sysGroupForm" method="post" name="sysGroupForm" style="width: 100%" class="hgform">
            ...
            <table style="width: 100%" class="hgtable">
                <tr>
                    ...
                    <td width="140px">
                        <select id="orgId" name="orgId" class="easyui-combotree" 
                            panelHeight='auto' panelMaxHeight="300" style="width:133px;"   
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <textarea type="text" name="descr"  multiline="true" 
                            style="height:80px;width:360px;overflow-x:hidden;" >${group.descr}</textarea>
                    </td>
                </tr>
            </table>
        </form>
