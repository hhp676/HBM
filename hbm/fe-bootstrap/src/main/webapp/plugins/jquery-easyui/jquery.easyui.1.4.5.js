...
(function($) {
	...
	$.parser = {
	    ...
	    plugins: [
	            "draggable", "droppable", "resizable", "pagination", "tooltip2", "linkbutton", "menu", "menubutton",
...
(function($) {
	function init(_1ee) {
		$(_1ee).addClass("tooltip2-f");
	}
	;
	function _1ef(_1f0) {
		var opts = $.data(_1f0, "tooltip2").options;
		$(_1f0).unbind(".tooltip2").bind(opts.showEvent + ".tooltip2", function(e) {
			$(_1f0).tooltip2("show", e);
		}).bind(opts.hideEvent + ".tooltip2", function(e) {
			$(_1f0).tooltip2("hide", e);
		}).bind("mousemove.tooltip2", function(e) {
			if (opts.trackMouse){
				opts.trackMouseX = e.pageX;
				opts.trackMouseY = e.pageY;
				$(_1f0).tooltip2("reposition");
			}
		});
	}
	;
	function _1f1(_1f2) {
		var _1f3 = $.data(_1f2, "tooltip2");
		if (_1f3.showTimer){
	...
	function _1f4(_1f5) {
		...
		if ($(_1f5).is(":visible")){
			...
			if (pos.left < 0){
				if (opts.position == "left"){
					...
					$(_1f5).tooltip2("arrow").css("left", tip._outerWidth() / 2 + pos.left);
					pos.left = 0;
				}
			}
			else{
				if (pos.left + tip._outerWidth() > $(window)._outerWidth() + $(document)._scrollLeft()){
					if (opts.position == "right"){
						...
						$(_1f5).tooltip2("arrow").css("left", tip._outerWidth() / 2 - (pos.left - left));
					}
				}
			}
		}
		...
		function _1f7(_1f8) {
			...
			tip.removeClass("tooltip2-top tooltip2-bottom tooltip2-left tooltip2-right").addClass(
			        "tooltip2-" + opts.position);
			var left, top;
			if (opts.trackMouse){
				t = $();
	...
	function _1f9(_1fa, e) {
		var _1fb = $.data(_1fa, "tooltip2");
		var opts = _1fb.options;
		var tip = _1fb.tip;
		if (!tip){
			tip = $(
			        "<div tabindex=\"-1\" class=\"tooltip2\">" + "<div class=\"tooltip2-content\"></div>"
			                + "<div class=\"tooltip2-arrow-outer\"></div>" + "<div class=\"tooltip2-arrow\"></div>"
			                + "</div>").appendTo("body");
			_1fb.tip = tip;
			_1fc(_1fa);
		}
		...
		_1fb.showTimer = setTimeout(function() {
			$(_1fa).tooltip2("reposition");
			tip.show();
			opts.onShow.call(_1fa, e);
			var _1fd = tip.children(".tooltip2-arrow-outer");
			var _1fe = tip.children(".tooltip2-arrow");
	...
	function _1fc(_202, _203) {
		...
		_204.tip.children(".tooltip2-content").html(cc);
		opts.onUpdate.call(_202, cc);
	}
	;
	function _205(_206) {
		var _207 = $.data(_206, "tooltip2");
		if (_207){
			_1f1(_206);
			...
			$.removeData(_206, "tooltip2");
			$(_206).unbind(".tooltip2").removeClass("tooltip2-f");
			opts.onDestroy.call(_206);
		}
	}
	;
	$.fn.tooltip2 = function(_208, _209) {
		if (typeof _208 == "string"){
			return $.fn.tooltip2.methods[_208](this, _209);
		}
		_208 = _208 || {};
		return this.each(function() {
			var _20a = $.data(this, "tooltip2");
			if (_20a){
				$.extend(_20a.options, _208);
			}
			else{
				$.data(this, "tooltip2", {
					options: $.extend({}, $.fn.tooltip2.defaults, $.fn.tooltip2.parseOptions(this), _208)
				});
				init(this);
			}
			_1ef(this);
	...
	$.fn.tooltip2.methods = {
	    options: function(jq) {
		    return $.data(jq[0], "tooltip2").options;
	    },
	    tip: function(jq) {
		    return $.data(jq[0], "tooltip2").tip;
	    },
	    arrow: function(jq) {
		    return jq.tooltip2("tip").children(".tooltip2-arrow-outer,.tooltip2-arrow");
	    },
	    show: function(jq, e) {
		    return jq.each(function() {
			    _1f9(this, e);
	...
	$.fn.tooltip2.parseOptions = function(_20c) {
		var t = $(_20c);
...
(function($) {
	...
	function _232(_233) {
		...
		t.find(".tooltip2-f").each(function() {
	...
	function _49a(_49b, _49c, _49d) {
		...
		if (_49d == "hide" || !_49c){
			...
			if (t.is(":focus") || _49d == "show"){
				t.tooltip2($.extend({}, opts.tipOptions, {
				    content: _49c,
