	...
	function _22c(_22d, _22e) {
		...
		if (!_22f.isLoaded || !opts.cache){
			...
			if (opts.loadingMessage){
                ...
                var cntHeight = $(_22d).height();
                cntHeight = (cntHeight == 0)? '100%':(cntHeight-11)+'px';
				$(_22d).html($("<div class=\"panel-loading panel-loading-hg\" style='width:"+cntWidth+"px;height:"+cntHeight+";padding:11px 0 0 0;text-indent: 30px;position:absolute;background-color:#ffffff;z-index:10;'></div>").html(opts.loadingMessage));
			}
