    ...
    <table singleSelect=true fit=true id="dauthVariable_grid"
        ...
        <thead>
            <tr>
                ...
                <th data-options="field:'variableValue',width:230" sortable="true" editor="{type:'textbox',options:{required:true,validType:{length:[1,3000]},missingMessage:'此输入项为必填项'}}">变量值</th>
                <th data-options="field:'engName',width:100" sortable="true" editor="{type:'textbox',options:{validType:['onlyEng','length[0,60]']}}">英文名称</th>
                <th data-options="field:'i18nCode',width:120" sortable="true" editor="{type:'textbox',options:{validType:{length:[0,60]}}}">国际化编码</th>
