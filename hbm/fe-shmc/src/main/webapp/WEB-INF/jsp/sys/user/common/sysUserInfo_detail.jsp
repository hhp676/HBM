					...
					<form class="hgform">
						<table class="hgtable" style="line-height: 25px">
							...
							<tr>
								...
								<td style="width: 170px;">
									<select type="text" name="gender" class="easyui-combobox" disabled="disabled" 
									     style="width: 146px;" panelHeight='auto'
							...
							<tr>
								...
								<td colspan="3">
									<input name="email" disabled="disabled" value="${user.email}" style="width: 370px;" /><br/>
							...
							<tr>
								...
								<td colspan="3">
									<input name="address" disabled="disabled" value="${user.address}" style="width: 370px;" /><br/>
								</td>
							</tr>
							<tr>
								<td align="right">描述：</td>
								<td colspan="3">
									<textarea name="descr" cols=80 rows=3 disabled="disabled" style="width: 366px; height: 30px;">${user.descr}</textarea><br/>
								</td>
							</tr>
						</table>
					</form>
