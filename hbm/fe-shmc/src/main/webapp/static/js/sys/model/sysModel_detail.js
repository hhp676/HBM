function initSysModelDetail(mode) {
	if (sysModel.mode == "view"){
		...
		$("#sysModel_form input[name=isBsTopMenu]").attr("disabled", 'disabled');
		$("#sysModel_form input[name=isBsSubMenu]").attr("disabled", 'disabled');
	...
	if (mode == "add"){
		...
		$("input[name=isBsTopMenu]:eq(0)").attr("checked", 'checked');
		$("input[name=isBsSubMenu]:eq(0)").attr("checked", 'checked');
	}
	...
	$("#sysModelDetail_layout [tag='change']").click(function() {
		
		$("#sysModelDetail_layout i[name='iconname']").removeClass();
		$("#sysModelDetail_layout i[name='iconname']").addClass("fa fa-upload");
		$("#sysModelDetail_layout input[name='bsStyle']").val("fa fa-upload");
